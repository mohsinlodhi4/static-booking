...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
   ...
   <body>
      ...
      <div class="services_section layout_padding">
         <div class="container">
            <div id="service" class="services_taital">Our Services</div>
      ...
      <div id="project" class="project_section_3 layout_padding">
         ...
         <div class="contact_section_2 layout_padding">
            <div class="container">
               <div class="mail_section">
                  <div class="row">
                     <div class="col-md-6">
                        <input type="text" class="input_text" placeholder="Name" id="name" name="name">
                     </div>
                     <div class="col-md-6">
                        <input type="email" class="input_text" placeholder="Email" id="email" name="email">
                     </div>
                  </div>
                  <input type="tel" class="input_text" placeholder="Phone Number" id="phone" name="phone">
                  <input type="text" class="input_text" placeholder="Sqm" id="sqm" name="sqm">
                  <textarea  class="massage_box" form="usrform" id="message" name="message" placeholder="Message"></textarea>
                  <div class="send_bt">
                     <button class="send_text" type="submit" style="
                           float: left;
                           font-size: 20px;
                           color: #ffffff;
